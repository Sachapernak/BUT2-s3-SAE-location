...
public class RequeteSelectTotalChargeDeduc extends Requete<Bail>{

	@Override
	public String requete() {
	    return "{call pkg_solde_compte.sous_total(?, ?, ?, ?, ?, ?)}";
	}
	...
	public void parametres(CallableStatement prSt, String... id) throws SQLException {
	    ...
	    // p_total_charge, p_total_deduc
	    prSt.registerOutParameter(5, java.sql.Types.DECIMAL);
	    prSt.registerOutParameter(6, java.sql.Types.DECIMAL);
	}
